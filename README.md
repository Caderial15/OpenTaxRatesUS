...
### Economic Nexus Source
- **Source URL**: New Jersey Division of Taxation – [Remote Seller guidance](https://www.streamlinedsalestax.org/for-businesses/remote-seller-faqs/remote-seller-state-guidance) (effective Nov 1, 2018)
- **Update Frequency**: Static ($100k or 200 transactions)
...
### Sales Tax Rate Sources
- **State Rate URL**: New Mexico TRD – [Gross Receipts Tax Rates](https://tap.state.nm.us/TapLogon.aspx) (state 5.0% base rate)
...
- **ZIP Code Mapping URL**: New Mexico TRD – [Tax Rate Map](https://www.tax.newmexico.gov/businesses/gross-receipts-tax-historic-rates/) (online GIS map and address lookup for GRT rates)
...
### Economic Nexus Source
- **Source URL**: New York State Department of Taxation – [Remote Seller Guidance](https://www.streamlinedsalestax.org/for-businesses/remote-seller-faqs/remote-seller-state-guidance) (NY Tax Law §1101(b)(8)(iv) effective June 21, 2018)
- **Update Frequency**: Static (NY threshold: >$500k and >100 sales/year, per statute)
- **Data Format**: Webpage (NYDTF remote seller FAQ)
- **API Available**: No

### Sales Tax Rate Sources
- **State Rate URL**: NY Department of Taxation – [Publication 718](https://www.tax.ny.gov/pdf/publications/sales/pub718.pdf) (state 4% base rate and combined rates by jurisdiction)
- **Local Rates URL**: NY Department of Taxation – Publication 718 (lists each county and city's total sales tax rate) and **[Online Sales Tax Jurisdiction Database](https://www.tax.ny.gov/bus/st/strate.htm)**
...
- **ZIP Code Mapping URL**: NYDTF – [Sales Tax Jurisdiction Lookup](https://www.tax.ny.gov/bus/st/lookup.htm) (by address or ZIP+4 on NY tax website)
- **Data Format**: PDF publication updated **quarterly**; also a downloadable jurisdiction CSV via NY Open Data
- **API Available**: Yes – New York provides a **[Sales Tax API](https://data.ny.gov/resource/8h6r-j6g3.json)** for address-based rate lookup (via the NY Geocode API)
